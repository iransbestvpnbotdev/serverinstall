...
if [ "${ARCH}" = "x86_64" ] ; then
wget "https://github.com/iransbestvpnbotdev/remotend-server/releases/download/asset/rustdesk-server-linux-amd64.zip"
unzip rustdesk-server-linux-amd64.zip
mv amd64/* /opt/rustdesk/
elif [ "${ARCH}" = "armv7l" ] ; then
wget "https://github.com/iransbestvpnbotdev/remotend-server/releases/download/asset/rustdesk-server-linux-armv7.zip"
unzip rustdesk-server-linux-armv7.zip
mv armv7/* /opt/rustdesk/
elif [ "${ARCH}" = "aarch64" ] ; then
wget "https://github.com/iransbestvpnbotdev/remotend-server/releases/download/asset/rustdesk-server-linux-arm64v8.zip"
...
function setuphttp () {
    ...
    wget https://raw.githubusercontent.com/iransbestvpnbotdev/serverinstall/master/WindowsAgentAIOInstall.ps1
    ...
    wget https://raw.githubusercontent.com/iransbestvpnbotdev/serverinstall/master/linuxclientinstall.sh
